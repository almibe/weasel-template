...
data class ScalarToken(val selector: String): Token // ScalarToken("user.address.city")
...
data class EachToken(val listSelector: String, val iteratorName: String): Token // EachToken("users", "user")
